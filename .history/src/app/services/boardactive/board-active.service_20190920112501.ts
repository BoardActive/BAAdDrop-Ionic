...
export class BoardActiveService {
    ...
    public APP_URL_PROD = 'https://api.boardactive.com/mobile/v1/';
    public APP_URL_DEV = 'https://springer-api.boardactive.com/mobile/v1/';
    public APP_KEY_PROD = 'b70095c6-1169-43d6-a5dd-099877b4acb3';
    public APP_KEY_DEV = 'd17f0feb-4f96-4c2a-83fd-fd6302ae3a16';
