    ...
    public getEnvironment(): Observable<any> {
        ...
        return new Observable((observer) => {
            this.localStorageService.getItem('environment').subscribe(env => {
                ...
                switch (env) {
                    case 'prod': {
                        this.localStorageService.setItem('AppKey', Config.APP_KEY.APP_KEY_PROD);
                    ...
                    case 'dev': {
                        this.localStorageService.setItem('AppKey', Config.APP_KEY.APP_KEY_DEV);
...
*/
    ...
    */
    ...
    addMessage(msg: MessageDto) {
        ...
        msg.notificationId = msg['gcm.message_id'];
        let messages: MessageDto[] = [];                
        this.localStorageService.getItem('messages').subscribe(data => {
            messages = data;
            messages.push(msg);
