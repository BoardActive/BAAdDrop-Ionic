...
export class BoardActiveService {
    ...
    */
    ...
    getEnvironment(): string {
        ...
        switch (env) {
            case 'prod': {
                localStorage.setItem('AppKey', Config.APP_KEY.APP_KEY_PROD);
                return Config.API_URL.APP_URL_PROD;
                break; 
            }
            case 'dev': {
                localStorage.setItem('AppKey', Config.APP_KEY.APP_KEY_DEV);
                return Config.API_URL.APP_URL_DEV;
                break; 
            }
            default: {
                localStorage.setItem('AppKey', Config.APP_KEY.APP_KEY_PROD);
