...
const routes: Routes = [
  { path: '', redirectTo: 'ba-reports', pathMatch: 'full' },
  ...
  { path: 'ba-reports', loadChildren: () => import('./pages/ba/ba-reports/ba-reports.module').then( m => m.BaReportsPageModule), canActivate: [GuardsService] },
  { path: 'ba-reports-ngx', loadChildren: () => import('./pages/ba/ba-report-ngx/ba-report-ngx.module').then( m => m.BaReportNgxPageModule)},
