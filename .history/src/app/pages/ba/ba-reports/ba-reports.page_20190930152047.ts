    ...
    this.localStorageService.getItem('appId').subscribe(appId => {
      ...
      this.baService.getApp(this.appId).subscribe(appData => {    
        ...
        if (appData.subscription) {
          ...
          this.users_quota = 5;
          this.places_quota = appData.subscription.quota.numberOfPlace;
          this.messages_quota = appData.subscription.quota.liveMessages;
        }

        console.log(`[BA APP ID]: ${JSON.stringify(appData, null, 2)}`);
      });
    });
  ...
  buildPieCharts() {
    ...
    this.pieChartPlaces = {
      ...
      dataTable: [
        ...
        ['Available', this.places_avail - this.places_used]
      ],
      options: {
        width: '100%',
        height: 400,
    ...
    this.pieChartMessages = {
      ...
      dataTable: [
        ...
        ['Available', this.messages_avail - this.messages_used]
      ],
      options: {
        width: '100%',
        height: 400,
